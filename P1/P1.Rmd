...
#par(mfrow=c(1,2))
DF_MIX[DF_MIX$Age1stCode > 80 & !is.na(DF_MIX$Age1stCode),]
boxplot(as.numeric(DF_MIX$Age1stCode) ~ DF_MIX$Region, probability = TRUE, main = "Edad 1er programa Estados Unidos", ylab = "Frecuencia relativa", xlab = "Region", cex.main = 0.9, horizontal = TRUE)
