...
Luego del análisis de la variable, se llega a la hipótesis de que en Estados Unidos realizan su primer programa antes que en América Latina. Sin embargo, la diferencia es de apenas un poco más de un año, además en América Latina las edades están más concentradas a su media.
...
legend(0,0.000005,legend=c("media"),col=c("red"),lwd=2)
...
legend(0,0.00004,legend=c("media"),col=c("blue"),lwd=2)
```
...
```
Gracias a la alta correlación, se pude determinar las funciones definidas anteriormente pueden dar cierta garantía y "predecir" cuantos años de experiencia laboral podría tener alguien cierta edad.
...
Al igual que en el anterior caso, se optó por utilizar un diagrama de dispersión con colores para diferenciar la variable categórica de la región. Las funciones de las regresiones que resultan en la remuneración anual son las siguientes:

- Estados Unidos:   f(edad) = 1313 × edad + 47529
- América Latina:   f(edad) = 983.5 × edad - 8830.5

Se puede apreciar en el cuadro que ambas variables parecen tener cierta relación, para verificar esto se analizara el valor de la covarianza. Se puede ver que ambas son positivas, sin embargo, el valor de la covarianza de Estados Unidos es mucho mayor que la de América Latina.
...
```
Se decidió utilizar un diagrama de dispersión por colores por los motivos ya mencionados anteriormente. Se puede observar en el diagrama que la regresión lineal tiene pendiente positiva en ambos casos. Las funciones de la regresiones lineales son las siguientes:

- Estados Unidos:   f(años) = 1319 × años + 80777
- América Latina:   f(años) = 1222 × años - 12018

Se recurre a las covarianzas para ver el grado de asociación en las variables y se ve que en ambos casos es positiva, lo que indicaría que las variables crecen en la misma dirección. 
...
```
Luego de la revisión de los descriptores, se plantea la hipótesis de que, si bien las correlaciones no son muy altas, el sueldo aparentemente tiene poco que ver con la edad de los que trabajan en empresas pequeñas en Estados Unidos, mientras que en América latina aparentemente, la edad de los que trabajan para estas empresas están mucho más relacionadas con el dinero que ganan anualmente.

### Modelos de variable aleatoria para variables de interés

#### ¿Cual es la probabilidad de que un desarrollador profesional de Estados Unidos o de América latina tenga un sueldo anual "estándar"?

Anteriormente se definió utilizando fuentes bibliográficas y el gráfico original, una variable booleana que nos permite definir si un programador posee un sueldo anual "estándar" o no. Utilizando esta variable se puede definir una variable aleatoria discreta que se distribuye en una Bernoulli p. Cuando un programador gane un sueldo estándar, será considerado un éxito, y cuando gane más del será un fracaso. Se calcula la probabilidad de éxito par ambas regiones:
...
#### ¿Cual es la probabilidad de que un desarrollador profesional de Estados Unidos o de América latina trabaje en una empresa que cuente con un buen proceso de incorporación?
