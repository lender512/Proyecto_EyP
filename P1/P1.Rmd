...
barplot(table(satis_vector_USA), main = "Estados Unidos", names.arg = variables1, col = c("blue","orange","yellow", "green", "red"))



barplot(table(satis_vector_LC), names.arg = variables1 , main = "América Latina", col = c("blue","orange","yellow", "green", "red"))
